...
axis(1, at = c(0,1), labels = c("Reputational Influence", "Twitter Centrality Ranking"), line = NA, lty=0,padj = -1.5, font = 2)
...
rm(twitter.in, inf.tw, inf25.tw, mat, org_en, ot.col)
